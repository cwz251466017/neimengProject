						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<c:if test="${postname1 != null}">
											<tr>
												<td style="width:79px;text-align: right;padding-top: 13px;">职位1:</td>
												<td><input type="text" name="postname1" id="postname1"  value="${postname1 }"  maxlength="32" title="职位1" style="width:98%;" disabled="disabled"/></td>
											</tr>
										</c:if>	
										<c:if test="${postname2 != null}">
											<tr>
												<td style="width:79px;text-align: right;padding-top: 13px;">职位2:</td>
												<td><input type="text" name="postname2" id="postname2"  value="${postname2 }"  maxlength="32" title="职位2" style="width:98%;" disabled="disabled"/></td>
											</tr>
										</c:if>	
										<c:if test="${postname3 != null}">
										     <tr>
												<td style="width:79px;text-align: right;padding-top: 13px;">职位3:</td>
												<td><input type="text" name="postname3" id="postname3"  value="${postname3 }"  maxlength="32" title="职位3" style="width:98%;" disabled="disabled"/></td>
											 </tr>
										</c:if>
										<c:if test="${postname4 != null}">	
											<tr>
												<td style="width:79px;text-align: right;padding-top: 13px;">职位4:</td>
												<td><input type="text" name="postname4" id="postname4"  value="${postname4 }"  maxlength="32" title="职位4" style="width:98%;" disabled="disabled"/></td>
											</tr>
										</c:if>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">头像:</td>
											<td><img src="/${pd.HEAD_PATH }" style="width:80px;height:80px;"></td>
										</tr>
