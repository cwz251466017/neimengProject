...
public class DictionariesService implements DictionariesManager{
	...
	public List<PageData> findDictionariesLikeBianMa(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.findDictionariesLikeBianMa", pd);
	}
