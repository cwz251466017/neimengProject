...
public class DepartmentController extends BaseController {
	...
	@RequestMapping(value="/relateUsers")
	public ModelAndView relateAffairs()throws Exception{
		...
		List<PageData> usersList = userService.listUsers(pd);
		
		mv.addObject("usersList", usersList);
		mv.addObject("pd",pd);
		mv.setViewName("fhoa/department/relateUser_list");
		return mv;
	}
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("BZ", "");
		pd.put("FUNCTIONS", "");
		pd.put("CREATE_TIME", Tools.date2Str(date,"yyyy-MM-dd HH:mm:ss"));
		pd.put("UPDATE_TIME", Tools.date2Str(date,"yyyy-MM-dd HH:mm:ss"));
	...
	public ModelAndView goAdd()throws Exception{
		...
		pd.put("BIANMA", "DT001");
		List<PageData> typeList = dictionariesService.findDictionariesLikeBianMa(pd);
	...
	public ModelAndView goEdit()throws Exception{
		...
		String DEPARTMENT_ID = pd.getString("DEPARTMENT_ID");			//1.复原本ID
		pd = departmentService.findById(pd);	//根据ID读取
		String BIANMA = pd.getString("BIANMA");							//2.复原本BIANMA
		...
		pd.put("DEPARTMENT_ID",DEPARTMENT_ID);							//1.复原本ID
		
		pd.put("BIANMA", "DT001");
		List<PageData> typeList = dictionariesService.findDictionariesLikeBianMa(pd);
		mv.addObject("typeList", typeList);
		pd.put("BIANMA", BIANMA);										//2.复原本BIANMA
		mv.setViewName("fhoa/department/department_edit");
